...
feature -- single feature test
	...
	test_get_element
		do
			...
			create t
			print ("t e' vuota, t restituisce 3?")
			print (t.get_element (3))
			print (r)
			t.append (3)
			print ("t contiene 3, t restituisce 3?")
			print (t.get_element (3))
			print (r)
			print ("t contiene 3, t restituisce 4?")
			print (t.get_element (4))
			print (r)
			t.append (7)
			print ("t contiene 3 e 7, t restituisce 3?")
			print (t.get_element (3))
			print (r)
			print ("t contiene 3 e 7, t restituisce 4?")
			print (t.get_element (4))
			print (r)
			print ("t contiene 3 e 7, t restituisce 7?")
