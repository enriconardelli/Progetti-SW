note
	description: "GEN_VS_LINKED_LIST application root class"
	date: "$Date$"
	revision: "$Revision$"

class
	GEN_VS_LINKED_LIST_ROOT
...
feature
	...
	make
			...
			-- Run application.
		local
			t: detachable GEN_VS_LINKED_LIST [INTEGER]
			target: detachable GEN_VS_LINKABLE [INTEGER]
		do
			create t
			t.stampa
			...
			t.insert_before (9, 5)
			t.stampa
--			print ("%N il conteggio degli elementi positivi e' ")
--			print(t.count_of_positive)
