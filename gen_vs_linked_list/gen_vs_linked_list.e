note
	description: "Summary description for {GEN_VS_LINKED_LIST}."
	author: ""
	date: "$Date$"
	revision: "$Revision$"
...
feature --query fondamentali
	...
	get_element (a_value: G): detachable GEN_VS_LINKABLE [G]
	...
	count_of_positive____RICHIEDE_GENERICO_G_IMPLEMENTI_PROPRIETA_POSITIVO: INTEGER
...
--				temp = Void
--			loop
--				if temp.value.is_positive then
