...
public class Conf {
	...
	public static final Integer default_frame_width = 300;
	public static final Integer default_frame_height = 300;
	public static final String default_button_tooltip = "This is an event";
	public static final String default_button_color = "LIGHT_GRAY";
