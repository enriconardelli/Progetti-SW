...
2) <scxml>
	...
	ATTRIBUTI
                ...
                C'è xmlns="http://www.w3.org/2005/07/scxml".   OK        
   		C'è version="1.0".
                             OK
...
6) <transition> (controlliamo solo quelli che sono figli di state o parallel)
	...
	ATTRIBUTI
		...
		C'è almeno uno tra evento condizione e target         	OK
 		Se c'è il target, allora è uno stato valido (cioè esiste), se non c'è si intende che è una transizione interna   OK
