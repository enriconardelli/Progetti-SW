...
--			t := create{INT_LINKED_LIST}
			...
			print ("%N remove_all 10: ")
			t.remove_all (10)
			print ("%N -- RISULTATO: "); t.stampa

			print ("%N insert 10 before 1: ")
			t.insert_before (10, 1)
			print ("%N insert 10 before 2: ")
			t.insert_before (10, 2)
			print ("%N insert 10 before 3: ")
			t.insert_before (10, 3)
			print ("%N insert 10 before 4: ")
			t.insert_before (10, 4)
			print ("%N -- RISULTATO: "); t.stampa;

			print ("%N -- ELEMENTO ATTIVO: "); print (t.active_element.value)
			print ("%N invoco forth: ")
			t.forth
			print ("%N -- ELEMENTO ATTIVO: "); print (t.active_element.value)
			print("%N invoco remove_all 10:")
			t.remove_all (10)
			print ("%N -- RISULTATO: "); t.stampa
			print ("%N -- ELEMENTO ATTIVO: "); print (t.active_element.value)
			print ("%N -- FIRST_ELEMENT: "); print (t.first_element.value)
			print ("%N -- LAST_ELEMENT: "); print (t.last_element.value)

			print("%N invoco remove_all 4:")
			t.remove_all (4)
			print ("%N -- RISULTATO: "); t.stampa
			print ("%N -- ELEMENTO ATTIVO: "); print (t.active_element.value)
			print ("%N -- FIRST_ELEMENT: "); print (t.first_element.value)
			...
			t.append (4)
			print ("%N -- RISULTATO: "); t.stampa;
			print ("%N insert 10 after 1: ")
			t.insert_after (10, 1)
			print ("%N insert 10 after 2: ")
			t.insert_after (10, 2)
			print ("%N insert 10 after 3: ")
			t.insert_after (10, 3)
			print ("%N insert 10 after 4: ")
			t.insert_after (10, 4)
			print ("%N -- RISULTATO: "); t.stampa;
			...
			print("%N invoco remove_all 1:")
			t.remove_all (1)
			print ("%N -- RISULTATO: "); t.stampa
			print ("%N -- ELEMENTO ATTIVO: "); if t.active_element /= Void then print (t.active_element.value) else print("Void") end
			print ("%N -- FIRST_ELEMENT: "); if t.first_element /= Void then print (t.first_element.value) else print("Void") end
			print ("%N -- LAST_ELEMENT: "); if t.last_element /= Void then print (t.last_element.value) else print("Void") end
			print ("%N cancello tutto: ")
			t.wipeout
			print ("%N -- RISULTATO: "); t.stampa;
			print ("%N ================================ %N%N")
